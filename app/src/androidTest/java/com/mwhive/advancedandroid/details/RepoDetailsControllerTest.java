...
public class RepoDetailsControllerTest extends ControllerTest {
  ...
  public void repoDetailsSuccess() {
    ...
    RepoDetailsRobot.init()
        .verifyLoadingVisibility(Visibility.GONE)
        .verifyName("RxJava")
  ...
  public void repoDetailsError(){
    ...
    RepoDetailsRobot.init()
        .verifyLoadingVisibility(Visibility.GONE)
        .verifyContentVisibility(Visibility.GONE)
  ...
  public void contributorsSuccess() {
    launch();
    RepoDetailsRobot.init()
        .verifyContributorsLoadingVisibility(Visibility.GONE)
        .verifyContributorsErrorVisibility(Visibility.GONE)
        .verifyContributorShow("benjchristensen");
  }
  ...
  @Test
  public void repoSeccessContributorsError() {
    repoService.setErrorFlags(TestRepoService.FLAG_GET_CONTRIBUTORS);
    launch();
    RepoDetailsRobot.init()
        .verifyLoadingVisibility(Visibility.GONE)
        .verifyContributorsLoadingVisibility(Visibility.GONE)
        .verifyContributorsErrorText(R.string.api_error_contributors)
        .verifyErrorVisibility(Visibility.GONE);
  }
  ...
  public void loadingRepo() {
    ...
    launch();
    RepoDetailsRobot.init().verifyLoadingVisibility(Visibility.VISIBLE);
  }
  ...
  public void loadingContributors() {
    ...
    launch();
    RepoDetailsRobot.init().verifyContributorsLoadingVisibility(Visibility.VISIBLE);
  }

  @Override
  protected Controller controllerToLaunch() {
    return RepoDetailsController.newInstance("ReativeX", "RxJava");
