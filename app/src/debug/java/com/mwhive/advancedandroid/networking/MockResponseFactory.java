package com.mwhive.advancedandroid.networking;
...
class MockResponseFactory {
  ...
  @Inject
  public MockResponseFactory(Context context, @Named("base_url") String baseUrl) {
  ...
  private String getEndpoint(Request request) {
    ...
    return queryParamStart == -1 ? url.substring(startIndex)
